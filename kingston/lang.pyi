...
def isprimitive(obj: Any) -> Any: ...
def isprim_type(type_: Any) -> Any: ...
def tolerant_or_original(Exc: Any, fn: Any) -> Any: ...
def coerce_or_same(T: Any) -> str: ...

maybe_int: Any

def methdispatch(func: Any) -> Any: ...

class Undefined: ...

def primbases(cls: Any) -> None: ...
def bind_methods(Base: Any, instance: Any) -> Any: ...
...
class Base:
    ...
    __classmethod__: Any = ...
    @classmethod
    def classmethod(cls: Any, fn: Any) -> Any: ...
    @staticmethod
...
class Piping(pipelib.BasePiping):
    ...
    kind: Any = ...
    seed: Any = ...
    def __init__(self, seed: Union[tuple, Any]=..., kind: Callable=..., format: Callable[[Any, None, None], Any]=...) -> None: ...
    cursor: Any = ...
    ops: Any = ...
    results: Any = ...
    last_result: Any = ...
    ...
    @property
    def state(self) -> None: ...
    def calc_fmt_param(self, kind: Any, res: Any, params: Any, case: Any) -> Any: ...
...
class LogicPiping(Piping):
    ...
    def __init__(self, seed: Union[tuple, Any]=..., kind: Callable=..., format: Callable[[Any, None, None], Any]=...) -> None: ...
    counter: Any = ...
    def logically(self, stepf: Any, conjunction: Any) -> Any: ...
    def __call__(self, *params: Any) -> Any: ...
